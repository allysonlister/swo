 ...
 * [swo.yml](swo.yml)
     * Determines how your purl.obolibrary.org/obo/swo/ redirects will be handled
     ...
     * Paste in the contents of [swo.yml](swo.yml)
 ...
 * [swo.md](swo.md)
     ...
     * Paste in the contents of [swo.md](swo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
